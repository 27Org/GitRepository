Ext.define('app.view.cOMSettings.Edit', {
    extend: 'ux.form.Panel',
    alternateClassName: 'cOMSettingsEdit',
    xtype: 'cOMSettingsEdit',
    initComponent:function(){
		...
		me.userfieldset = new Ext.form.FieldSet({xtype: 'fieldset',title: 'COM',defaults: {xtype:"textfield",anchor: '70%',readOnly:display},
	        ...
	        items: [
	        	//一定要改成动态的
//				{xtype:'combobox',fieldLabel: 'PortName',name:'portName',
...
//					    proxy: {
//					        type: 'ajax',
//					        url: '../cOMSettings.do?method=getAllCOM',
//					        reader: {
//					            type: 'json',
//					            root: 'data'
//					    	}
...
//    	EU.toastWarn(cOMSettingsid);
    	form.submit({ 
            url: '../cOMSettings.do?method=openCOM',
            params:{"cOMSettingsid":cOMSettingsid},
            success:function(form,action){ 
